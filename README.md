...
## Purpose
With the scripts in this repo it should be easy possible to install, uninstall, restart a service that connects ~~the~~ three Shelly 3EM to the VenusOS and GX devices from Victron.
